...
- For `codex:codex-it`, do not turn a failed or incomplete Codex run into a Claude-side implementation attempt. Report the failure and stop.
- For `codex:codex-it`, if Codex was never successfully invoked, do not generate a substitute answer at all.
